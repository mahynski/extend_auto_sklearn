"""
Extend auto-sklearn to include additional feature preprocessors.
...
class RFE(AutoSklearnPreprocessingAlgorithm):
    """Recursive feature elimination preprocessor."""
    ...
    def fit(self, X, y=None):
        ...
        if self.base_estimator == "rf":
            ...
            raise ValueError(
                "Unrecognized base estimator {}".format(self.base_estimator)
            )

        import sklearn.feature_selection

        self.preprocessor = sklearn.feature_selection.RFE(
            estimator=base,
    ...
    def get_properties(dataset_properties=None):
        """Get the properties of this preprocessor."""
        return {
            "shortname": "RFE",
...
class SparsePCA(AutoSklearnPreprocessingAlgorithm):
    """Sparse PCA preprocessor."""

    def __init__(
        self, n_components, tol, alpha, ridge_alpha, random_state=None
    ):
        """Initialize the class."""
        ...
        self.tol = tol
        self.random_state = (
            random_state  # Could be deterministic if set to a value?
        )
        self.preprocessor = None
    ...
    def fit(self, X, y=None):
        ...
        self.preprocessor = sklearn.decomposition.SparsePCA(
...
class LDA(AutoSklearnPreprocessingAlgorithm):
    ...
    def __init__(
        self, solver, n_components, tol, shrinkage=None, random_state=None
    ):
        """Initialize the class."""
        self.solver = solver
